 ...
 */
public class OptionRedSmallTriangle extends OptionBase {
  ...
  public static OptionRedSmallTriangle.Params PARAMS = new OptionRedSmallTriangle.Params();

  public OptionRedSmallTriangle(LinearOpMode autoOpMode, FtcBot robot, Follower follower) {
    super(autoOpMode, robot, follower);
    follower.setStartingPose(startPose);
  }

  public OptionRedSmallTriangle init() {
    // third artifact rwo
