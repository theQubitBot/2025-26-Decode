...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    public static double TICKS_PER_REV = 8192.0; // REV through bore encoder
    public static double WHEEL_RADIUS = 0.6889765; // in; RotaCaster 35 mm Omni wheels
    public static double GEAR_RATIO = 1.0; // output (wheel) speed / input (encoder) speed

    public static double LATERAL_DISTANCE = 6.40; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -2.45; // in; offset of the lateral wheel
