 ...
 */
public class OptionRedLargeTriangle extends OptionBase {
  ...
  public static OptionRedLargeTriangle.Params PARAMS = new OptionRedLargeTriangle.Params();

  public OptionRedLargeTriangle(LinearOpMode autoOpMode, FtcBot robot, Follower follower) {
    super(autoOpMode, robot, follower);
    follower.setStartingPose(startPose);
  }

  public OptionRedLargeTriangle init() {
    // preloaded artifacts
